...
import re
import lmppl #
# constituency_parse: textwrap3
# sentence embedding: sentence_transformers
# factuality: pytorch_lightning
# readability: readability, textstat
# syntactic: spellchecker, language_tool_python, evaluate
# lda: sklearn
# topic: little_mallet_wrapper
...
if __name__ == '__main__':
    ...
    if 'all' in metrics or 'semantic' in metrics:
        ...
        data.insert(len(data.columns), "metric_rouge", df_metrics['rougeL'])
